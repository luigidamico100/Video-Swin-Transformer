...
DATASET_DIR_IN=/home/luigi.damico/ICPR_datasets/ICPR_rawframes_numframes${NUM_FRAMES_PER_VIDEO}/
...
do
  ...
  --cfg-options model.backbone.pretrained=backbones/swin_tiny_patch4_window7_224.pth \
